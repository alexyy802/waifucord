...
This is the documentation for senpai.py, a library for Python to aid
in creating applications that utilise the Discord API.

Prerequisites
---------------

senpai.py works with Python 3.8 or higher. Support for earlier versions of Python
...
You can get the library directly from PyPI: ::
    ...
    python3 -m pip install -U senpai.py

If you are using Windows, then the following should be used instead: ::

    py -3 -m pip install -U senpai.py


To get voice support, you should use ``senpai.py[voice]`` instead of ``senpai.py``, e.g. ::

    python3 -m pip install -U senpai.py[voice]
...
senpai.py revolves around the concept of :ref:`events <senpai-api-events>`.
