...
``senpai.uwu.owo`` -- asyncio.Task helpers
====================================================
...
The goal of this senpai.py extension is to abstract all these worries away from you.

Recipes
---------

A simple background task in a :class:`~senpaiuwuwaifu.Cog`:

.. code-block:: python3

    from senpaiuwu import tasks, commands
...
.. attributetable:: senpaiuwuowo.Loop

.. autoclass:: senpaiuwuowo.Loop()
    :members:
...
.. autofunction:: senpaiuwuowo.loop
